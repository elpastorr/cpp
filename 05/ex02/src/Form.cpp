...
const char	*Form::ExecNotSigned::what(void) const throw()
{
	return ("Exception: Can't execute form is not signed !");
}

const char	*Form::FileOpeningFail::what(void) const throw()
{
	return ("Exception: File can't be opened !");
}
